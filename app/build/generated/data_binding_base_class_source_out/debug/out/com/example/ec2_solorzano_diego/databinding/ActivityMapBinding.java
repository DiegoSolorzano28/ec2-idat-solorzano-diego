...
public final class ActivityMapBinding implements ViewBinding {
  ...
  private ActivityMapBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView fcvMap) {
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.fcv_map;
      FragmentContainerView fcvMap = ViewBindings.findChildViewById(rootView, id);
      if (fcvMap == null) {
        break missingId;
      }

      return new ActivityMapBinding((ConstraintLayout) rootView, fcvMap);
    }
